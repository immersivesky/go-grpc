...
func (c *messageServiceClient) GetMessage(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageReply, error) {
...
func (UnimplementedMessageServiceServer) GetMessage(context.Context, *MessageRequest) (*MessageReply, error) {
